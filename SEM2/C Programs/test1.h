...
}t;typedef struct BOOK bk;

void arrpush(bk *s,int *top,int size);
void arrpop(bk *s,int *top);
void arrpeek(bk *s,int *top);
void rev(bk *s,int *top);
